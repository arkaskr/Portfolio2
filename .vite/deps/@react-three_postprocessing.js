...
var $87431ee93b037844$export$2489f9981ab0fa82 = class extends (0, Pass) {
  ...
  configureAOPass(depthBufferType2 = (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Default, ortho = false) {
    this.firstFrame();
    ...
    if (depthBufferType2 === (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Log) e.fragmentShader = "#define LOGDEPTH\n" + e.fragmentShader;
    else if (depthBufferType2 === (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Reverse) e.fragmentShader = "#define REVERSEDEPTH\n" + e.fragmentShader;
  ...
  configureDenoisePass(depthBufferType2 = (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Default, ortho = false) {
    this.firstFrame();
    ...
    if (depthBufferType2 === (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Log) p2.fragmentShader = "#define LOGDEPTH\n" + p2.fragmentShader;
    else if (depthBufferType2 === (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Reverse) p2.fragmentShader = "#define REVERSEDEPTH\n" + p2.fragmentShader;
  ...
  configureEffectCompositer(depthBufferType2 = (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Default, ortho = false) {
    this.firstFrame();
    const e = {
